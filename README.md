...
8. **Мультивыполнение микрошагов в один день**: цикл «Другой микрошаг → Сделай сейчас → Отметить выполненным» можно повторять без лимита; на дашборде есть счётчик **«Выполнено сегодня»**
